...
<div
  class="mt-12 flex flex-col sm:flex-row gap-y-2 items-center justify-center gap-x-2 sm:gap-y-0"
>
  <slot />
  ...
  <div>
    <button
      ...
      class="group inline-flex items-center gap-x-2 rounded-lg border border-slate-400 px-3 py-2 text-sm font-medium text-slate-700 hover:border-blue-500 hover:bg-blue-500"
      class:bg-blue-500={userChoice === 'helpful'}
      class:border-blue-500={userChoice === 'helpful'}
    >
