      ...
      <div className="pointer-events-none absolute inset-0 bg-background">
        ...
        {study.logo && (
          <motion.div
            ...
            className="absolute -right-[10%] top-[62%] hidden h-[58vw] w-[58vw] max-h-[640px] max-w-[640px] -translate-y-1/2 lg:block"
          >
            ...
            <img
              ...
              style={{
                opacity: 0.22,
                WebkitMaskImage: "radial-gradient(closest-side, black 22%, transparent 88%)",
                maskImage: "radial-gradient(closest-side, black 22%, transparent 88%)",
              }}
            />
          </motion.div>
        )}
        {/* Legibility scrim so page copy always reads cleanly over the mark */}
        <div className="absolute inset-y-0 left-0 hidden w-[64%] bg-gradient-to-r from-background via-background/85 to-transparent lg:block" />
