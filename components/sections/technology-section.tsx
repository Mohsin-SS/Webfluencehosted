...
function ScrollRevealText({ text }: { text: string }) {
  ...
  return (
    <p
      ref={containerRef}
      className="text-3xl font-semibold leading-snug text-[#0a0a0a] md:text-4xl lg:text-5xl"
    >
              ...
              >
                {textCycles.map((text, cycleIndex) => {
                  ...
                  return (
                    <h2 
                      key={cycleIndex}
                      className="absolute max-w-3xl font-medium leading-tight tracking-tight text-[#0a0a0a] md:text-5xl lg:text-7xl text-5xl"
                    >
