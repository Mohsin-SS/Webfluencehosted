...
import { ServiceRelatedWork } from "@/components/service-related-work"
...
export default async function ServicePage({
  ...
  return (
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* Service pricing */}
      <div id="pricing" className="scroll-mt-24 border-t border-border bg-secondary/40">
        <ServicePricing slug={service.slug} title={service.title} />
      </div>

      {/* Related work */}
      <ServiceRelatedWork slug={service.slug} title={service.title} />
